...
try:
    from _compat22 import _floordiv
except SyntaxError:
    # Python 2.1 spells integer division differently
    from _compat21 import _floordiv
...
def decode_header(header):
    ...
    An Errors.HeaderParseError may be raised when certain decoding error
    ...
    for line in header.splitlines():
        ...
        while parts:
            ...
            if parts:
                ...
                dec = None
                if encoding == 'q':
                    dec = quopriMIME.header_decode(encoded)
                elif encoding == 'b':
                    try:
                        dec = base64MIME.decode(encoded)
...
class Header:
    ...
    def _encode_chunks(self, newchunks, maxlinelen):
        ...
        #
        # Each encoding can be Utils.QP (quoted-printable, for
        # ASCII-like character sets like iso-8859-1), Utils.BASE64
